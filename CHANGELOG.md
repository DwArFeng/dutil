...
## Release_2.0.0_20260722_build_A
...
- `dutil-basic` 子模块类优化注释、文档注释格式、代码换行格式。
  - com.dwarfeng.dutil.basic.gui.swing.JExconsole。
