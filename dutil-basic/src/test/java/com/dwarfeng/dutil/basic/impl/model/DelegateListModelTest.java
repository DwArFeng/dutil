...
public class DelegateListModelTest {
    ...
    private final ListObserverFixture<String> obv = new ListObserverFixture<>();
    ...
    public void testIterator() {
        ...
        assertEquals("0", obv.removeElements.getFirst());
        i.next();
        i.next();
        i.remove();
    ...
    public void testAddE() {
        model.add("4");
        assertEquals(Integer.valueOf(4), obv.addedIndexes.getFirst());
        assertEquals("4", obv.addedElements.getFirst());
        assertEquals(5, model.size());
    ...
    public void testRemoveObject() {
        ...
        assertEquals(Integer.valueOf(1), obv.removeIndexes.getFirst());
    ...
    public void testListIterator() {
        ...
        i.add("2");
        assertArrayEquals(new String[]{"0", "2", "3"}, model.toArray(new String[0]));
        assertEquals(Integer.valueOf(1), obv.addedIndexes.getFirst());
        ...
        assertEquals(Integer.valueOf(3), obv.changedIndexes.getFirst());
        assertEquals("3", obv.changedOldElements.getFirst());
        assertEquals("4", obv.changedNewElements.getFirst());
    }
    ...
    public void testEqualsObject() {
        ...
        list.add("1");
        assertNotEquals(model, list);
        assertNotEquals(list, model);
    }
