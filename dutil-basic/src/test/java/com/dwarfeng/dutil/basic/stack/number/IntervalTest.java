...
public class IntervalTest {
    ...
    public void testHashCode() {
        ...
        Interval interval0 = new Interval(
                BoundaryType.CLOSED, BoundaryType.OPENED, new BigDecimal(12450), new BigDecimal("12450.12")
        );
        @SuppressWarnings("DuplicateExpressions")
    ...
    public void testParseInterval0() {
        ...
        assertSame(BoundaryType.CLOSED, interval.leftBoundaryType());
        assertSame(BoundaryType.OPENED, interval.rightBoundaryType());
        assertEquals(new BigDecimal("0.12"), interval.leftValue());
    ...
    public void testParseInterval4() {
        assertThrows(IllegalArgumentException.class, () -> Interval.parseInterval("( 12450.12 , 12450 )"));
    }
    ...
    public void testInterval() {
        assertThrows(
                ...
                () -> new Interval(
                        BoundaryType.CLOSED, BoundaryType.CLOSED, new BigDecimal("12450.12"), new BigDecimal(12450)
                )
        );
    }
    ...
    public void testToStringIntRoundingMode() {
        ...
        CT.trace(interval.toString(2, RoundingMode.HALF_DOWN));
    }
}
