...
import com.dwarfeng.dutil.basic.stack.model.KeyListModel;
...
public class DelegateKeyListModel<K, V extends WithKey<K>> extends DelegateListModel<V> implements KeyListModel<K, V> {
    ...
    public boolean containsAllKey(Collection<?> c) {
        Objects.requireNonNull(c, BasicMessages.message(BasicMessageKey.KEY_LIST_MODEL_COLLECTION_REQUIRED));
        for (Object o : c) {
            if (!containsKey(o)) {
                return false;
            }
