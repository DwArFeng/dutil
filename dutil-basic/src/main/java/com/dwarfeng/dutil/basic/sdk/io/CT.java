...
import com.dwarfeng.dutil.basic.sdk.string.StringUtil;
...
public final class CT {
    ...
    public static void setOutputType(OutputType outputType) {
        Objects.requireNonNull(outputType, BasicMessages.message(BasicMessageKey.CT_OUTPUT_TYPE_REQUIRED));
    ...
    public static void setMutiLineType(MultiLineType mutiLineType) {
        Objects.requireNonNull(mutiLineType, BasicMessages.message(BasicMessageKey.CT_MULTILINE_TYPE_REQUIRED));
    ...
    private static String getTimePrefix() {
        ...
        return switch (outputType) {
            case FULL_DATE -> {
                ...
                yield formatter.format(new Date());
            }
            case HALF_DATE -> {
    ...
    private static String multiLine2(String prefix, String string) {
        ...
        sb.append(prefix).append("\t").append(BasicMessages.message(BasicMessageKey.CT_MULTILINE_TEXT)).append("\n");
