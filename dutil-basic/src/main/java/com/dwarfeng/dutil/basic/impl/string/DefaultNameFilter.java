...
import com.dwarfeng.dutil.basic.stack.string.NameFilter;
...
public class DefaultNameFilter<T> implements NameFilter<T> {
    ...
    public DefaultNameFilter(String name, Filter<? super T> delegateFilter) {
        Objects.requireNonNull(name, BasicMessages.message(BasicMessageKey.NAME_FILTER_NAME_REQUIRED));
        Objects.requireNonNull(delegateFilter, BasicMessages.message(BasicMessageKey.NAME_FILTER_DELEGATE_REQUIRED));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof DefaultNameFilter<?> other))
            return false;
