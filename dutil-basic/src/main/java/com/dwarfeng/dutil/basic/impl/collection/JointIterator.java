...
public class JointIterator<T> implements Iterator<T> {
    ...
    public static class Builder<T> implements Buildable<JointIterator<T>> {
        ...
        public Builder<T> append(Iterator<T> iterator) {
            Objects.requireNonNull(iterator, BasicMessages.message(BasicMessageKey.ITERATOR_CHAIN_ITERATOR_REQUIRED));
        ...
        public Builder<T> append(Iterable<T> iterable) {
            Objects.requireNonNull(iterable, BasicMessages.message(BasicMessageKey.ITERATOR_CHAIN_ITERABLE_REQUIRED));
        ...
        public Builder<T> append(T[] array) {
            Objects.requireNonNull(array, BasicMessages.message(BasicMessageKey.ITERATOR_CHAIN_ARRAY_REQUIRED));
