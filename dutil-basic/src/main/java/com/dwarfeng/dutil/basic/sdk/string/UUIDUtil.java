...
public final class UUIDUtil {
    ...
    public static String toDenseString(UUID uuid) {
        Objects.requireNonNull(uuid, BasicMessages.message(BasicMessageKey.UUID_VALUE_REQUIRED));
    ...
    private UUIDUtil() {
        throw new IllegalStateException(BasicMessages.message(BasicMessageKey.UUID_INSTANTIATION_FORBIDDEN));
    }
}
