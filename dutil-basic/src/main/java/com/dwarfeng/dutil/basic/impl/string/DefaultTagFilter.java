...
import com.dwarfeng.dutil.basic.stack.string.TagFilter;
...
public class DefaultTagFilter<T> extends DefaultNameFilter<T> implements TagFilter<T> {
    ...
    public DefaultTagFilter(String name, String description, Filter<? super T> delegateFilter) {
        ...
        Objects.requireNonNull(description, BasicMessages.message(BasicMessageKey.TAG_FILTER_DESCRIPTION_REQUIRED));
    ...
    public boolean equals(Object obj) {
        ...
        if (!super.equals(obj))
            return false;
        if (!(obj instanceof DefaultTagFilter<?> other))
            return false;
        if (description == null) {
