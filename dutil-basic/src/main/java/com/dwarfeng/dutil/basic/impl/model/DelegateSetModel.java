...
public class DelegateSetModel<E> extends AbstractSetModel<E> {
    ...
    public DelegateSetModel(Set<E> delegate, Set<SetObserver<E>> observers) {
        super(observers);
        Objects.requireNonNull(delegate, BasicMessages.message(BasicMessageKey.SET_MODEL_DELEGATE_REQUIRED));
    ...
    public boolean containsAll(Collection<?> c) {
        Objects.requireNonNull(c, BasicMessages.message(BasicMessageKey.SET_MODEL_COLLECTION_REQUIRED));
