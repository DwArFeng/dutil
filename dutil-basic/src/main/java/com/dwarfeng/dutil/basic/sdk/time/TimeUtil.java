...
public final class TimeUtil {
    ...
    public static Instant toInstant(Date date, int nanoOffset) {
        Objects.requireNonNull(date, BasicMessages.message(BasicMessageKey.TIME_DATE_REQUIRED));
    ...
    public static Date toDate(Instant instant) {
        Objects.requireNonNull(instant, BasicMessages.message(BasicMessageKey.TIME_INSTANT_REQUIRED));
    ...
    public static int compare(Date date1, int nanoOffset1, Date date2, int nanoOffset2) {
        Objects.requireNonNull(date1, BasicMessages.message(BasicMessageKey.TIME_FIRST_DATE_REQUIRED));
        Objects.requireNonNull(date2, BasicMessages.message(BasicMessageKey.TIME_SECOND_DATE_REQUIRED));
    ...
    public static void checkNanoOffset(int nanoOffset) {
        ...
        throw new IllegalArgumentException(BasicMessages.message(BasicMessageKey.TIME_NANO_OFFSET_INVALID));
    }
