 ...
 * @since 0.4.0-beta
 */
public class Url2RepoResource extends AbstractResource {
     ...
     */
    public Url2RepoResource(String key, URL def, File repoDir, String classify, String fileName) {
        super(key);
    ...
    public InputStream openInputStream() throws IOException {
        ...
        return Files.newInputStream(res.toPath());
    }
    ...
    public OutputStream openOutputStream() throws IOException {
        File res = getResourceFile();
        return Files.newOutputStream(res.toPath());
    }
    ...
    public void reset() throws IOException {
        ...
        try {
            in = def.openStream();
            out = Files.newOutputStream(res.toPath());
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        // TODO 暂时忽略相关警告，等待研究后替换更优的代码。
        @SuppressWarnings("UrlHashCode")
        int defHashCode = def.hashCode();
        result = prime * result + ((classify == null) ? 0 : classify.hashCode());
        result = prime * result + defHashCode;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Url2RepoResource other = (Url2RepoResource) obj;
        if (classify == null) {
        ...
        if (def == null) {
            ...
            // TODO 暂时忽略相关警告，等待研究后替换更优的代码。
            @SuppressWarnings("UrlHashCode")
            boolean flag = !def.equals(other.def);
            if (flag) {
                return false;
            }
        }
    ...
    private File getResourceFile() {
        return new File(repoDir, classify + File.separator + fileName);
    }
}
