...
import com.dwarfeng.dutil.base.internal.i18n.ResourceMessageResolver;
import com.dwarfeng.dutil.base.stack.i18n.MessageCatalog;
import com.dwarfeng.dutil.base.stack.i18n.MessageResolver;
 ...
 *
 * <p>
 * 该工具为 dutil 各模块提供统一的语言环境调度、资源查找、格式化与缺失资源降级。
 *
 * <p>
 * 该类型属于 dutil 内部集成机制。
 *
